...
## Thr R script "run_analysis.R" is explained in detail below:
...
17.  This tidy summary talbe is then saved as a .csv file in the data file of the working directory.
